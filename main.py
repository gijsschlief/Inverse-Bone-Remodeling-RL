...
def main():
    ...
    p_forward.add_argument("--rho_min", type=float, default=0.01, help="Minimum bone density")
    p_forward.add_argument("--rho_max", type=float, default=1.74, help="Maximum bone density")
