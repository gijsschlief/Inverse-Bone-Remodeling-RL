...
def test_splitting_shapes_and_sizes():
    ...
    Y = np.arange(100)
    X_train, X_val, X_test, y_train, y_val, y_test = splitting(X, Y, random_state=42, train_size=0.7, val_size=0.15, test_size=0.15)
...
def test_splitting_reproducibility():
    ...
    Y = np.arange(20)
    result1 = splitting(X, Y, random_state=123, train_size=0.5, val_size=0.3, test_size=0.2)
    result2 = splitting(X, Y, random_state=123, train_size=0.5, val_size=0.3, test_size=0.2)
