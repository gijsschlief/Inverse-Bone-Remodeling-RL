"""Visualize the forward model data and force profiles."""
...
def analyse_raw_data(data_path: Path) -> None:
    ...
    triangular_forward_data_manager = ForwardDataManager(data_path / Path("triangular"))
    triangular_data = triangular_forward_data_manager.load_directory()
