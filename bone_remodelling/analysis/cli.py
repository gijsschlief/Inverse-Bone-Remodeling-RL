...
def cli(config: ConfigurationParameters, argv: list[str]) -> None:
    ...
    if args.type == "forward_parameter_sweep":
        ...
        from bone_remodelling.analysis.max_force_sweep import run_sweep_and_analyse as max_force_sweep  # noqa: I001, PLC0415
        max_force_sweep(config.output_dir / Path("sweeps", "max_force_sweep"))
    elif args.type == "visualise_forces":
        from bone_remodelling.analysis.visualise_force_profiles import analyse_force_generator as visualise_forces  # noqa: I001, PLC0415
        visualise_forces()
    elif args.type == "visualise_database":
        from bone_remodelling.analysis.visualise_database import analyse_raw_data as visualise_database  # noqa: I001, PLC0415
