...
from bone_remodelling.surrogate_model.evaluator import average_similarity_score
...
from bone_remodelling.surrogate_model.trainer import load_and_split_data
